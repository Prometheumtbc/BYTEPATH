...
function PathfinderConsoleInputLine:enter()
    local command = self.text:utf8sub(15, -1)
...
function PathfinderConsoleInputLine:draw()
...
function PathfinderConsoleInputLine:setCharacters()
    self.characters = {}
...
function PathfinderConsoleInputLine:keypressed(key)
    if self.console.input_line and self.console.input_line.id == self.id then
...
function PathfinderConsoleInputLine:help()
    self.console.input_line = nil
    self.console.bytepath_main = nil
    table.insert(self.console.modules, PathfinderHelpModule(self.console, self.console.line_y))
end
